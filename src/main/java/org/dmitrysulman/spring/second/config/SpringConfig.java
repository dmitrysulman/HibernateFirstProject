package org.dmitrysulman.spring.second.config;
...
@Configuration
@ComponentScan("org.dmitrysulman.spring.second")
@EnableWebMvc
@EnableTransactionManagement
@PropertySource("classpath:hibernate.properties")
@EnableJpaRepositories("org.dmitrysulman.spring.second.repositories")
public class SpringConfig implements WebMvcConfigurer {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        entityManagerFactoryBean.setPackagesToScan("org.dmitrysulman.spring.second.models");
